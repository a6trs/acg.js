...
acg.ext.nametag = function (title, subtitle, sx, sy) {
    ...
    txt1.setColor(acg.colour.BLACK);
    l.addChild(txt1);
    ...
    txt2.setColor(acg.colour.BLACK);
    l.addChild(txt2);
    acg.init_matter(l,
        // FIXME: Opacity 0 doesn't work here...
        {x: sx, y: sy, ax: 0, ay: 0, opacity: 0.001, colour: acg.colour.BLACK,
